        ...
        children: [
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ElevatedButton(
              ...
              style: ButtonStyle(
                  backgroundColor:
                      MaterialStateProperty.all<Color>(const Color(0xFFCD00B9)),
            ...
            ElevatedButton(
              ...
              style: ButtonStyle(
                  backgroundColor:
                      MaterialStateProperty.all<Color>(const Color(0xFFFF9900)),
                  padding: MaterialStateProperty.all<EdgeInsets>(
                      const EdgeInsets.all(16.0)),
                  shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                      RoundedRectangleBorder(
            ...
            ElevatedButton(
              ...
              style: ButtonStyle(
                  backgroundColor:
                      MaterialStateProperty.all<Color>(const Color(0xFF039000)),
                  padding: MaterialStateProperty.all<EdgeInsets>(
                      const EdgeInsets.all(16.0)),
                  shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                      RoundedRectangleBorder(
                ...
                children: [
                  Container(
                    margin: const EdgeInsets.only(
                        right: 5.0), //margin at time in right side
