...
import '../schedules/create_schedule.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          /*
          *
          * This is the headings that contains the teachers name, profile image, and current date
          *
          * */
          Row(
          ...
          * */
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            createListPageNavButton(context, const ListOfSubjects(), 0xFFCD00B9,
            ...
            createListPageNavButton(
                ...
                "Schedule List"),
            const SizedBox(height: 7),
            createListPageNavButton(context, const AttendanceReport(), 0xFF039000,
